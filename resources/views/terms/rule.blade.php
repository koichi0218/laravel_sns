    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-11 col-lg-8">
                <h2>利用規約</h2>
                <p class="mt-3">
                この利用規約（以下，「本規約」といいます。）は，ゆるかき（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
                </p>
                <h4 class="mt-3">第1条（適用）</h4>
                <ol>
                ...
                <h4 class="mt-3">第3条（ユーザーIDおよびパスワードの管理）</h4>
                <ol>
                ...
                <h4 class="mt-3">第5条（本サービスの提供の停止等）</h4>
                <ol>
                ...
                <h4 class="mt-3">第7条（利用制限および登録抹消）</h4>
                <ol>
                ...
                <h4 class="mt-3">第8条（退会）</h4>
                <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>
                <h4 class="mt-3">第9条（保証の否認および免責事項）</h4>
                <ol>
                ...
                <h4 class="mt-3">第14条（権利義務の譲渡の禁止）</h4>
                <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                <h4 class="mt-3">第15条（準拠法・裁判管轄）</h4>
                <ol>
